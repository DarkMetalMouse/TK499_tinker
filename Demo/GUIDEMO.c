...
static void _Main(void) {
  ...
  xSize           = LCD_GetXSize();
  ySize           = LCD_GetYSize();
  _hDialogControl = GUI_CreateDialogBox(_aFrameWinControl, GUI_COUNTOF(_aFrameWinControl), &_cbFrameWinControl, WM_HBKWIN, xSize - CONTROL_SIZE_X-50, ySize - CONTROL_SIZE_Y-50);
...
//  while (1) {}
  ...
  WM_SetCallback(WM_HBKWIN,0);//取消背景回调函数
